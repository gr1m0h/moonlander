...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_CAPSLOCK,    KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_H,                                                                           KC_J,           KC_K,           KC_L,           KC_SCOLON,      KC_QUOTE,       KC_GRAVE,       KC_ENTER,       
    KC_LSHIFT,      KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSHIFT,      
    OSL(1),         KC_LCTRL,       KC_LALT,        KC_LGUI,        LALT(LGUI(KC_ESCAPE)),KC_LANG2,                                                                                                       KC_LANG1,       KC_RGUI,        KC_LEFT,        KC_UP,          KC_DOWN,        KC_RIGHT,       
